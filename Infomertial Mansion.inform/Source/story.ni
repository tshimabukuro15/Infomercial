...
The Jumbo Sized Bonsai Tree is a container in the foyer. It is closed and openable. It is fixed in place. The description is "What exactly is the point of a large miniature tree? The tree is off center, as if someone could pull out the tree and open the pot."
...
The dog is an animal. The dog is in Marty's room. The description is "The Marty's dog, the horribe chihuahua, is now asleep after accepting its offering. It shouldn't bother you for a while."
